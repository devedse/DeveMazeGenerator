...
## Algorithms
* AlgorithmBacktrack (100%)
* AlgorithmKruskal (100%)
* AlgorithmDivisionBreadthFirst (30%) (Needs to be converted from my old project to this one)
* AlgorithmDivisionDepthFirst (0%) (Needs to be converted from my old project to this one)
* AlgorithmEller (0%)
